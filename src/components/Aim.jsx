...
function Aim() {
  return (
    <div className='flex-col mx-[24px] mt-[50px]  lg:mt-[133px] '>
        <div className='bg-[#1A3A28] px-[20px] lg:px-[81px] lg:py-[99px] py-[30px] rounded-[20px] lg:flex justify-between lg:items-center'>
        ...
        <div className='px-[20px] py-[36px] bg-[#EBFF6E] mt-[16px] rounded-[20px]'>
            <div className='grid lg:grid-cols-2 justify-between items-center'>
                ...
                <div className='flex lg:justify-end justify-center mt-[32px] lg:mt-0 w-full'>
                <img src={girl} />
                </div>
            </div>
